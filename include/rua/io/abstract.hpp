...
using reader_i = adapted_ptr<reader>;
...
using writer_i = adapted_ptr<writer>;

class read_writer : public reader, public writer {};

using read_writer_i = adapted_ptr<read_writer>;
...
using closer_i = adapted_ptr<closer>;

class read_closer : public reader, public closer {};

using read_closer_i = adapted_ptr<read_closer>;

class write_closer : public writer, public closer {};

using write_closer_i = adapted_ptr<write_closer>;

class read_write_closer : public read_writer, public closer {};

using read_write_closer_i = adapted_ptr<read_write_closer>;
...
using seeker_i = adapted_ptr<seeker>;

class read_seeker : public reader, public seeker {};

using read_seeker_i = adapted_ptr<read_seeker>;

class write_seeker : public writer, public seeker {};

using write_seeker_i = adapted_ptr<write_seeker>;

class read_write_seeker : public reader, public writer, public seeker {};

using read_write_seeker_i = adapted_ptr<read_write_seeker>;
...
using reader_at_i = adapted_ptr<reader_at>;
...
using writer_at_i = adapted_ptr<writer_at>;

class read_writer_at : public reader_at, public writer_at {};

using read_writer_at_i = adapted_ptr<read_writer_at>;

class read_writer_at_closer : public read_writer_at, public closer {};

using read_writer_at_closer_i = adapted_ptr<read_writer_at_closer>;
