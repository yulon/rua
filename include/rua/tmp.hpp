...
namespace rua {
	namespace tmp {
		...
		using _type_switch_muticase_handler = rebind_if<!Top::is_matched_v, Top, Cond, Others...>;

		template <typename Cond, typename Case, typename Result, typename... Others>
		struct type_switch<Cond, Case, Result, Others...> :
			_type_switch_muticase_handler<type_switch<Cond, Case, Result>, Cond, Others...>::type
		{};
