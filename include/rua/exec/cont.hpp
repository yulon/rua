			...
			public:
				...
				bool push() {
					static const uint8_t code[]{
								...
								0xD9, 0xB1, 0x94, 0x00, 0x00, 0x00, 0x48, 0xC7, 0xC0, 0x01, 0x00, 0x00, 0x00, 0xC3
							#else
				...
				void pop() const {
					static const uint8_t code[]{
								...
								0x58, 0x4C, 0x8B, 0x51, 0x60, 0x4C, 0x8B, 0x59, 0x68, 0x4C, 0x8B, 0x61, 0x70, 0x4C, 0x8B,
								0x69, 0x78, 0x4C, 0x8B, 0xB1, 0x80, 0x00, 0x00, 0x00, 0x4C, 0x8B, 0xB9, 0x88, 0x00, 0x00,
								0x00, 0x48, 0x8B, 0x51, 0x18, 0x0F, 0xAE, 0x91, 0x90, 0x00, 0x00, 0x00, 0xD9, 0xA1, 0x94,
								0x00, 0x00, 0x00, 0x48, 0x8B, 0x49, 0x10, 0x48, 0xC7, 0xC0, 0x00, 0x00, 0x00, 0x00, 0xC3
							#else
				...
				// OS context
					...
					uintptr_t seh_exception_list;
				#endif
		};

		#ifdef RUA_AMD64
			RUA_STATIC_ASSERT(offsetof(cont, fenv) == 148);
		#endif

		#ifdef RUA_I386
			RUA_STATIC_ASSERT(offsetof(cont, fenv) == 44);
		#endif
	}
}
