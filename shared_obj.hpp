...
namespace rua {
	...
	class shared_obj {
		...
		public:
			...
			D cast_with_type() const {
				static_assert(std::is_base_of<dynamic_shared_obj<typename D::access_type>, D>::value, "dest is not a 'rua::dynamic_shared_obj'");
			...
			template <typename D>
			D cast() const {
				static_assert(std::is_base_of<shared_obj<typename D::access_type>, D>::value, "dest is not a 'rua::shared_obj'");
				static_assert(!std::is_base_of<dynamic_shared_obj<typename D::access_type>, D>::value, "dest cannot be a 'rua::dynamic_shared_obj'");
	...
	class dynamic_shared_obj : public shared_obj<T> {
		...
		public:
			...
			template <typename D>
			bool type_is() {
				static_assert(std::is_base_of<shared_obj<typename D::access_type>, D>::value, "target is not a 'rua::shared_obj'");
